...
RSpec.describe GameQuestion, type: :model do
  ...
  context 'user helpers' do
    ...
    it 'help hash metods work correct' do
      ...
      game_question.add_audience_help
      expect(game_question.help_hash).to include(:fifty_fifty, :audience_help)

      game_question.add_friend_call
      expect(game_question.help_hash).to include(:fifty_fifty, :audience_help, :friend_call)
    end
